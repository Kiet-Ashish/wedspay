  ...
  <section id="title" class="padd-section">
          ...
          <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
              <ul class = "navbar-nav ms-auto">
                  ...
                  <li class="nav-item dropdown">
          			<a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">User Details</a>
			          <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
			            <li><a class="dropdown-item" href="${pageContext.request.contextPath}/user/marriageList">Marriages</a></li>
    ...
    <div class="row">
      <div class="col-lg-6">
        ...
        <button type="button" onclick="window.location.href='${pageContext.request.contextPath}/user/showForm'; return false;" class="btn btn-dark btn-lg download-button">Pay now</button>
      	<button type="button" onclick="window.location.href='showReg'; return false;" class="btn btn-outline-light btn-lg download-button">Register</button>
      </div>
      <div class="col-lg-6">
      ...
      <div class="col-md-4 col-sm-6 space">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <div class="d-grid">
              <button type="button" onclick="window.location.href='showReg'; return false;" class="btn btn-outline-dark">Sign Up</button>
            </div>
